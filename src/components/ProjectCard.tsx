...
export const ProjectCard = ({ imgUrl, title, description, gitUrl, previewUrl }: CardProps) => {
  return (
    <div className="flex flex-col rounded-xl overflow-hidden h-full bg-[#181818]">
      <div
        className="h-52 md:h-72 rounded-t-xl relative group"
        style={{ background: `url(${imgUrl})`, backgroundSize: "cover" }}
      >
        <div className="overlay items-center justify-center absolute top-0 left-0 w-full h-full bg-[#181818]/0 hidden group-hover:flex group-hover:bg-[#181818]/80 transition-all duration-500 ">
          <Link
            href={gitUrl}
